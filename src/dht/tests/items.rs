...
/// The live mainline's shape (yog's `docs/REMOTE.md` §13.7 ruling 3, yog
/// bl-f6e1): the bootstrap is a router that answers `find_node` and never `get`, and the item's home
