...
for its parent. The parent's goal is handed to you as `parent_goal` — judge
...
earlier intermediate compactions — read any prior summaries under `summary/`
before you write, and mark the previous summary for deletion when you supersede
it.
