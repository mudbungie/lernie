//! **The mTLS half** (REMOTE §1.3, §4): the rustls configuration a seat dials
...
//! that is most of why a seat installs cleanly on a laptop or a phone.
...
/// The seat's end: verify the engine against the operator CA, and present this
