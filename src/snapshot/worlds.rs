...
//! six are the shapes: nothing dialled yet, seated at a wall with a
//! conversation open, the wall with none selected, and the three states of the
//! two panes that cover the conversation.
//!
