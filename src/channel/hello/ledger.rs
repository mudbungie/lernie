//! **The per-bump ledger**, and the constant it re-exports.
//!
...
//! mechanism has carried, and it grows by one entry per bump, forever. A
//! module whose length is a function of how long the wire has existed does not
//! belong inside one whose length is a function of what it does.
//!
