...
pub fn render(ui: &mut egui::Ui, model: &mut Model, aim: &Aim, agent: &str) {
    ...
    ui.horizontal_wrapped(|ui| {
        ...
        // pane is what makes this seat read the selected conversation's steps
        // and files (`crate::state::Standing`), and the reads have no control
        // of their own. It leads the row because it spends nothing — every
