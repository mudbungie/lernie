...
**lernie's stance (authoritative definition in `docs/ARCHITECTURE.md` §2.1; mechanism in ARCH §2.3, addressing in ARCH §2.11).** lernie splits the two facts and lets neither stand in for the other:
...
### Retarget vocabulary (lernie-specific coinage)
...
lernie coins **tool control** (or **control**) for the adjudicator its `workflow.yaml` `tool_control:` block places in front of tool execution (`docs/ARCHITECTURE.md` §3.3 *Tool control*, ARCH §6), with three companion terms:
