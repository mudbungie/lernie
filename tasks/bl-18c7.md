+++
title = "the seat ships as an OCI image, and the display stack is the question the other three components did not have to answer"
created = 1788407694
updated = 1788583146
...
The seat's own repo now exists: bl-0716 landed the severance and the name flip, so the artifact this ball would ship has a home to be built from. The blocker stands as bl-320b — a seat that cannot dial a stated address has nothing to deploy, whatever repo it lives in.
  2026-08-30T05:47:07Z  OrderShipwright

Re-homed from yog bl-ae69 (closed there): the ball's own text says the answer is recorded in the repo the seat lives in, and that is this one. Its named blocker in yog's store, bl-320b, closed 2026-08-31.