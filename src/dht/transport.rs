...
//! failure arms no loopback socket will produce on demand (yog's
//! `docs/REMOTE.md` §13.5). Synchronous `std::net`, timeouts on the socket,
//! no tokio (`Cargo.toml`'s approved set refuses it).
